...
const mySecret = process.env['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'] // process.env['key-apikey'] ubah jadi key-APIKEY kamu di openai.com

const openai = new OpenAI({ apiKey: mySecret });

const Nomor = '6285224954965'
